        ...
        <Container>
            <Fundo>
                ...
                <Text>
                    ...
                    A Mostra Cenas Curtas será realizada no Theatro Municipal de Niterói, nos dias 19, 20 e 21 de setembro. Serão selecionadas 15 cenas. Cada uma receberá um cachê de participação de R$ 2.500,00, além de concorrer ao Prêmio Júri Popular, que acrescentará R$ 2.000,00 ao valor do cachê da cena premiada (baixe o Regulamento)<br /><br />
                ...
                <Text>
                    <strong>PRAZOS PARA SE INSCREVER: </strong> 
                    Mostra Cenas Curtas - até 31 de julho
                    Mostra Estudantil - até 20 de agosto
                </Text>
            </Fundo>
        </Container>
    )
